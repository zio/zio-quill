...
trait PostgresNdbcContextBase[N <: NamingStrategy]
    extends NdbcContextBase[
      PostgresDialect,
      N,
  ...
  override protected def createPreparedStatement(sql: String) =
    PostgresPreparedStatement.create(sql)
