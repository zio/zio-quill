...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "2.5.2"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "2.5.2"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "2.5.2"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "2.5.2"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "2.5.2"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "2.5.2"
)
```
