...
[![Build Status](https://img.shields.io/travis/getquill/quill.svg?branch=master)](https://travis-ci.org/getquill/quill)
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "0.2.0"
)
```
