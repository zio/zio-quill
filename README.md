...
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-spark" % "3.0.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  ...
  "io.getquill" %% "quill-jdbc" % "3.0.1-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "mysql" % "mysql-connector-java" % "5.1.38",
  "io.getquill" %% "quill-jdbc-monix" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-monix" % "3.0.1-SNAPSHOT"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "3.0.1-SNAPSHOT"
)
```
