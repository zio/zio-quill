...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "2.1.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "2.1.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "2.1.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "2.1.0"
)
```
