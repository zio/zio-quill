...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "2.3.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "2.3.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "2.3.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "2.3.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "2.3.0"
)
```
