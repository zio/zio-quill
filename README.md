...
libraryDependencies ++= Seq(
  "mysql" % "mysql-connector-java" % "8.0.17",
  "io.getquill" %% "quill-jdbc-monix" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-ndbc-postgres" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-mysql" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-async-postgres" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-jasync-mysql" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-jasync-zio-postgres" % "4.4.0"
)
```
...
```
libraryDependencies += "io.getquill" %% "quill-doobie" % "4.4.0"
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-mysql" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-finagle-postgres" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-zio" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-monix" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-cassandra-alpakka" % "4.4.0"
)
```
...
```
libraryDependencies ++= Seq(
  "io.getquill" %% "quill-orientdb" % "4.4.0"
)
```
