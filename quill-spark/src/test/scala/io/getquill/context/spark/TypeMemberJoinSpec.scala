              ...
              Map(
                Map(
                  FlatJoin(
                    ...
                    (Property(Id("c", QStr("CCA(id:V)")), "id") +==+ Property(Id("p", QStr("CC(name:V,childId:V)")),
                                                                              "childId"
                    ))
                  ),
                  Id("c", QStr("CCA(id:V)")),
              ...
              Map(
                FlatMap(
                  ...
                  Map(
                    FlatJoin(
                      ...
                      (Property(Id("g", QStr("CCA(parentId:V)")), "parentId") +==+ Property(Id("c", QStr("CCA(id:V)")),
                                                                                            "id"
                      ))
                    ),
                    Id("g", QStr("CCA(parentId:V)")),
                ...
                Tuple(
                  List(
                    ...
                    Property(Property(Id("x2", QStr("CC(_1:CCA(name:V,id:V),_2:CCA(name:V,parentId:V))")), "_1"),
                             "name"
                    )
                  )
                )
