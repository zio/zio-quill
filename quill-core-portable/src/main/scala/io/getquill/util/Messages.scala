...
object Messages {
  ...
  private[getquill] def quatKryoPoolSize =
  ...
  def enableTrace(color: Boolean = true,
  ...
  def qprintCustom(traceOpinions: Boolean = false,
