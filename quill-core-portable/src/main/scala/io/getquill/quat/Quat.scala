...
object Quat {
  ...
  class Product(val fields: mutable.LinkedHashMap[String, Quat],
    ...
    def copy(fields: mutable.LinkedHashMap[String, Quat] = this.fields,
  ...
  object Product {
    ...
    def apply(fields: (String, Quat)*): Quat.Product            =
      new Quat.Product(mutable.LinkedHashMap[String, Quat]() ++ fields.iterator, mutable.LinkedHashMap(), Type.Concrete)
    def apply(tpe: Type, fields: (String, Quat)*): Quat.Product =
      new Quat.Product(mutable.LinkedHashMap[String, Quat]() ++ fields.iterator, mutable.LinkedHashMap(), tpe)
    ...
    def apply(fields: Iterator[(String, Quat)]): Quat.Product            =
      new Quat.Product(mutable.LinkedHashMap[String, Quat]() ++ fields, mutable.LinkedHashMap(), Type.Concrete)
    def apply(tpe: Type, fields: Iterator[(String, Quat)]): Quat.Product =
      new Quat.Product(mutable.LinkedHashMap[String, Quat]() ++ fields, mutable.LinkedHashMap(), tpe)
    ...
    def apply(tpe: Type, fields: mutable.LinkedHashMap[String, Quat]): Quat.Product =
      new Quat.Product(fields, mutable.LinkedHashMap(), tpe)
  ...
  object Tuple   {
    ...
    def apply(fields: Iterable[Quat]): Quat.Product = Quat.Product(fields.zipWithIndex.map { case (f, i) =>
      (s"_${i + 1}", f)
    }.iterator)
  }
