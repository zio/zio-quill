...
object Ord {
  ...
  def apply[T1, T2, T3, T4, T5, T6](o1: Ord[T1],
                                    o2: Ord[T2],
                                    o3: Ord[T3],
                                    o4: Ord[T4],
                                    o5: Ord[T5],
  ...
  def apply[T1, T2, T3, T4, T5, T6, T7](o1: Ord[T1],
                                        o2: Ord[T2],
                                        o3: Ord[T3],
                                        o4: Ord[T4],
                                        o5: Ord[T5],
  ...
  def apply[T1, T2, T3, T4, T5, T6, T7, T8](o1: Ord[T1],
                                            o2: Ord[T2],
                                            o3: Ord[T3],
                                            o4: Ord[T4],
                                            o5: Ord[T5],
  ...
  def apply[T1, T2, T3, T4, T5, T6, T7, T8, T9](o1: Ord[T1],
                                                o2: Ord[T2],
                                                o3: Ord[T3],
                                                o4: Ord[T4],
                                                o5: Ord[T5],
  ...
  def apply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10](o1: Ord[T1],
                                                     o2: Ord[T2],
                                                     o3: Ord[T3],
                                                     o4: Ord[T4],
                                                     o5: Ord[T5],
