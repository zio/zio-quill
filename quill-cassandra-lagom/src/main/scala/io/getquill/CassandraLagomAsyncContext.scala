...
class CassandraLagomAsyncContext[+N <: NamingStrategy](
  ...
  def prepareAction[T](cql: String, prepare: Prepare = identityPrepare)(info: ExecutionInfo, dc: DatasourceContext)(
  ...
  def prepareBatchAction[T](groups: List[BatchGroup])(info: ExecutionInfo, dc: DatasourceContext)(implicit
    executionContext: ExecutionContext
  ): CassandraLagomSession => Future[List[BoundStatement]] = (session: Session) => {
