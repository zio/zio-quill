...
import io.getquill.context.jdbc.{
  H2JdbcComposition,
  JdbcRunContext,
  MysqlJdbcComposition,
  OracleJdbcComposition,
  PostgresJdbcComposition,
  SqlServerExecuteOverride,
  SqlServerJdbcComposition,
  SqliteJdbcComposition
}
...
class PostgresZioJdbcContext[N <: NamingStrategy](val naming: N)
  ...
  val underlying: ZioJdbcUnderlyingContext[PostgresDialect, N] =
    new PostgresZioJdbcContext.Underlying[N](naming)
}
...
class SqlServerZioJdbcContext[N <: NamingStrategy](val naming: N)
  ...
  val underlying: ZioJdbcUnderlyingContext[SQLServerDialect, N] =
    new SqlServerZioJdbcContext.Underlying[N](naming)
}
...
class H2ZioJdbcContext[N <: NamingStrategy](val naming: N)
  ...
  val underlying: ZioJdbcUnderlyingContext[H2Dialect, N] =
    new H2ZioJdbcContext.Underlying[N](naming)
}
...
class MysqlZioJdbcContext[N <: NamingStrategy](val naming: N)
  ...
  val underlying: ZioJdbcUnderlyingContext[MySQLDialect, N] =
    new MysqlZioJdbcContext.Underlying[N](naming)
}
...
class SqliteZioJdbcContext[N <: NamingStrategy](val naming: N)
  ...
  val underlying: ZioJdbcUnderlyingContext[SqliteDialect, N] =
    new SqliteZioJdbcContext.Underlying[N](naming)
}
...
class OracleZioJdbcContext[N <: NamingStrategy](val naming: N)
  ...
  val underlying: ZioJdbcUnderlyingContext[OracleDialect, N] =
    new OracleZioJdbcContext.Underlying[N](naming)
}
...
trait WithProbing[D <: SqlIdiom, N <: NamingStrategy]
    extends ZioJdbcUnderlyingContext[D, N] {
  def probingConfig: Config;
  override def probingDataSource: Option[DataSource] = Some(
    JdbcContextConfig(probingConfig).dataSource
  )
}

trait WithProbingPrefix[D <: SqlIdiom, N <: NamingStrategy]
    extends WithProbing[D, N] {
