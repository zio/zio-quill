...
trait ArrayDecoders extends ArrayEncoding {
  ...
  implicit def arrayDateDecoder[Col <: Seq[Date]](implicit bf: CBF[Date, Col]): Decoder[Col]                         =
    arrayDecoder[JodaLocalDateTime, Date, Col](_.toDate)
  ...
  implicit def arrayJodaLocalDateTimeDecoder[Col <: Seq[JodaLocalDateTime]](implicit
      bf: CBF[JodaLocalDateTime, Col]
