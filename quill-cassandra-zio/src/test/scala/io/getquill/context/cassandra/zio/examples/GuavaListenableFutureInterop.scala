...
/** Example of how to directly convert from a Guava ListenableFuture to a ZIO
  * Task (a CIO for Quill Cassandra). Can revert to this if zio/interop-guava
  * needs to be removed.
  */
object GuavaListenableFutureInterop {
  implicit class ZioTaskConverter[A](val lf: ListenableFuture[A])
      extends AnyVal {
    def asCio: CIO[A] = {
