...
abstract class JdbcContext[Dialect <: SqlIdiom, Naming <: NamingStrategy]
  ...
  )(executionInfo: ExecutionInfo, dc: Runner): O =
  ...
  )(executionInfo: ExecutionInfo, dc: Runner): List[Long] =
  ...
  override def prepareQuery(sql: String, prepare: Prepare = identityPrepare)(
      executionInfo: ExecutionInfo,
      dc: Runner
  ): Connection => PreparedStatement =
    super.prepareQuery(sql, prepare)(executionInfo, dc)
  override def prepareAction(sql: String, prepare: Prepare = identityPrepare)(
      executionInfo: ExecutionInfo,
      dc: Runner
  ): PrepareActionResult =
  ...
  override def prepareBatchAction(
      groups: List[BatchGroup]
  )(executionInfo: ExecutionInfo, dc: Runner): PrepareBatchActionResult =
    super.prepareBatchAction(groups)(executionInfo, dc)

  protected val currentConnection =
    new DynamicVariable[Option[Connection]](None)
