...
trait WithOracleContext extends WithContextAux {
  ...
  implicit def oracleContextForTest2: Aux[TheDB, `2-comp-stereo-single`, TheContext[
    SnakeCase
  ...
  implicit def oracleContextForTest3: Aux[TheDB, `3-comp-stereo-oneschema`, TheContext[
    Literal
  ...
  implicit def oracleContextForTest4: Aux[TheDB, `4-comp-stereo-twoschema`, TheContext[
    Literal
  ...
  implicit def oracleContextForTest5: Aux[TheDB, `5-comp-non-stereo-allschema`, TheContext[
    Literal
