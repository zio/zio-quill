...
trait WithSqlServerContext extends WithContextAux {
  ...
  implicit def sqlServerContextForTest2: Aux[TheDB, `2-comp-stereo-single`, TheContext[
    SnakeCase
  ...
  implicit def sqlServerContextForTest3: Aux[TheDB, `3-comp-stereo-oneschema`, TheContext[
    Literal
  ...
  implicit def sqlServerContextForTest4: Aux[TheDB, `4-comp-stereo-twoschema`, TheContext[
    Literal
  ] with `4-comp-stereo-twoschema-lib`.public.PublicExtensions[TheDialect,
                                                               Literal
  ...
  implicit def sqlServerContextForTest5: Aux[TheDB, `5-comp-non-stereo-allschema`, TheContext[
    Literal
  ] with `5-comp-non-stereo-allschema-lib`.public.PublicExtensions[TheDialect,
                                                                   Literal
  ] with `5-comp-non-stereo-allschema-lib`.alpha.AlphaExtensions[TheDialect,
                                                                 Literal
