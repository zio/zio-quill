...
import io.getquill.{
  SnakeCase,
  SqliteDialect => TheDialect,
  SqliteJdbcContext => TheContext
}
...
trait WithSqliteContext extends WithContextAux {
  ...
  implicit def sqliteSimpleContextForTest1
  ...
  implicit def sqliteSimpleContextForTest2
  ...
  implicit def sqliteContextForTest1
  ...
  implicit def sqliteContextForTest2
