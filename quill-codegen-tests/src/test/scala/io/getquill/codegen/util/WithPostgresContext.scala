...
trait WithPostgresContext extends WithContextAux {
  ...
  implicit def postgresContextForTest2: Aux[TheDB, `2-comp-stereo-single`, TheContext[
    SnakeCase
  ...
  implicit def postgresContextForTest3: Aux[TheDB, `3-comp-stereo-oneschema`, TheContext[
    Literal
  ...
  implicit def postgresContextForTest4: Aux[TheDB, `4-comp-stereo-twoschema`, TheContext[
    Literal
  ...
  implicit def postgresContextForTest5: Aux[TheDB, `5-comp-non-stereo-allschema`, TheContext[
    Literal
