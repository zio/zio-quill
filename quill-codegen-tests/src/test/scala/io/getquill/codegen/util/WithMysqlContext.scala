...
trait WithMysqlContext extends WithContextAux {
  ...
  implicit def mysqlContextForTest2: Aux[TheDB, `2-comp-stereo-single`, TheContext[
    SnakeCase
  ...
  implicit def mysqlContextForTest3: Aux[TheDB, `3-comp-stereo-oneschema`, TheContext[
    Literal
  ...
  implicit def mysqlContextForTest4: Aux[TheDB, `4-comp-stereo-twoschema`, TheContext[
    Literal
  ...
  implicit def mysqlContextForTest5: Aux[TheDB, `5-comp-non-stereo-allschema`, TheContext[
    Literal
