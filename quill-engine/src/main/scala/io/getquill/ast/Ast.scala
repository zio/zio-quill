...
object Infix {
  ...
  def unapply(i: Infix): Some[(List[String], List[Ast], Boolean, Boolean, Quat)] = Some(
...
object ScalarValueLift {
  ...
  def unapply(svl: ScalarValueLift): Some[(String, External.Source, Any, Any, Quat)] = Some(
