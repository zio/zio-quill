...
trait Unliftables extends QuatUnliftable {
  ...
  implicit val astUnliftable: Unliftable[Ast] = Unliftable[Ast] {
    ...
    case q"$_.Infix.apply(${ a: List[String] }, ${ b: List[Ast] }, ${ pure: Boolean }, ${ quat: Quat })" => Infix(a, b, pure, quat)
  ...
  implicit val binaryOperatorUnliftable: Unliftable[BinaryOperator] = Unliftable[BinaryOperator] {
    case q"$_.EqualityOperator.`==`"       => EqualityOperator.`==`
    case q"$_.EqualityOperator.`!=`"       => EqualityOperator.`!=`
  ...
  implicit val queryUnliftable: Unliftable[Query] = Unliftable[Query] {
    ...
    case q"$_.Entity.Opinionated.apply(${ a: String }, ${ b: List[PropertyAlias] }, ${ quat: Quat.Product }, ${ renameable: Renameable })" => Entity.Opinionated(a, b, quat, renameable)
  ...
  implicit val propertyUnliftable: Unliftable[Property] = Unliftable[Property] {
    ...
    case q"$_.Property.Opinionated.apply(${ a: Ast }, ${ b: String }, ${ renameable: Renameable }, ${ visibility: Visibility })" => Property.Opinionated(a, b, renameable, visibility)
  }
  ...
  implicit val valueUnliftable: Unliftable[Value] = Unliftable[Value] {
    ...
    case q"$_.CaseClass.apply(${ values: List[(String, Ast)] })" => CaseClass(values)
  }
  ...
  implicit val liftUnliftable: Unliftable[Lift] = Unliftable[Lift] {
    case q"$_.ScalarValueLift.apply(${ a: String }, $b, $c, ${ quat: Quat })" => ScalarValueLift(a, b, c, quat)
    case q"$_.CaseClassValueLift.apply(${ a: String }, $b, ${ quat: Quat })"  => CaseClassValueLift(a, b, quat)
  ...
  implicit val tagUnliftable: Unliftable[Tag] = Unliftable[Tag] {
    case q"$_.ScalarTag.apply(${ uid: String })"    => ScalarTag(uid)
