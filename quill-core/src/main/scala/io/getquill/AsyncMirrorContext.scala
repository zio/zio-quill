...
class AsyncMirrorContext[+Idiom <: BaseIdiom, +Naming <: NamingStrategy](
  ...
  def executeQuery[T](string: String, prepare: Prepare = identityPrepare, extractor: Extractor[T] = identityExtractor)(
    ...
    dc: Runner
  )(implicit ec: ExecutionContext): Future[QueryMirror[T]] =
  ...
  )(executionInfo: ExecutionInfo, dc: Runner)(implicit ec: ExecutionContext): Future[QueryMirror[T]] =
    Future(QueryMirror(string, prepare(Row(), session)._2, extractor, executionInfo))
  ...
  )(executionInfo: ExecutionInfo, dc: Runner)(implicit ec: ExecutionContext): Future[BatchActionMirror] =
    Future {
      BatchActionMirror(
  ...
  def executeBatchActionReturning[T](
    ...
    extractor: Extractor[T]
  )(executionInfo: ExecutionInfo, dc: Runner)(implicit ec: ExecutionContext): Future[BatchActionReturningMirror[T]] =
    Future {
