...
case class Filter(query: Expr, alias: Ident, body: Expr) extends Query

case class Map(query: Expr, alias: Ident, body: Expr) extends Query

case class FlatMap(query: Expr, alias: Ident, body: Expr) extends Query
