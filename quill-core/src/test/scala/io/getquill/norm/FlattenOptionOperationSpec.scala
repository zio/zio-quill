  ...
  "transforms option operations into simple properties" - {
    ...
    "getOrElse" in {
      ...
      new FlattenOptionOperation(AnsiConcat)(q.ast.body: Ast) mustEqual
        If(
          BinaryOperation(Ident("o"), EqualityOperator.`_!=`, NullValue),
          Ident("o"),
          Constant.auto(1)
        )
    }
    ...
    "map + getOrElse(true)" in {
      ...
      new FlattenOptionOperation(AnsiConcat)(
        q.ast.body: Ast
    ...
    "map + forall + binop" - {
      "regular operation" in {
        ...
        new FlattenOptionOperation(AnsiConcat)(q.ast.body: Ast) mustEqual
          ((IsNullCheck(Property(o, "i")) +||+ ((Property(
            o,
            "i"
          ) +!=+ c1))) +&&+ Constant.auto(true))
      }
      "possible-fallthrough operation" in {
        ...
        new FlattenOptionOperation(AnsiConcat)(q.ast.body: Ast) mustEqual
          ((IsNullCheck(Property(o, "s")) +||+ ((Property(
            o,
            "s"
          ) +++ cFoo) +==+ cBar) +&&+ Constant.auto(true)))
        new FlattenOptionOperation(NonAnsiConcat)(q.ast.body: Ast) mustEqual
          ((IsNullCheck(Property(o, "s")) +||+ (IsNotNullCheck(
            Property(o, "s")
          ) +&&+ ((Property(o, "s") +++ cFoo) +==+ cBar))) +&&+ Constant.auto(
            true
          ))
      }
    }
