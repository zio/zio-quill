...
class FlattenOptionOperationSpec extends Spec { //hello
  ...
  "transforms option operations into simple properties" - {
    ...
    "map + getOrElse(true)" in {
      ...
      new FlattenOptionOperation(AnsiConcat, TraceConfig.Empty)(q.ast.body: Ast).toString mustEqual "((o != null) && (o < 1)) || ((o == null) && true)"
    }
    "map + getOrElse(false)" in {
      val q = quote {
        (o: Option[Int]) => o.map(_ < 1).getOrElse(false)
      }
      new FlattenOptionOperation(AnsiConcat, TraceConfig.Empty)(q.ast.body: Ast).toString mustEqual "((o != null) && (o < 1)) || ((o == null) && false)"
    }
    "forall" - {
      "regular operation" in {
        val q = quote {
