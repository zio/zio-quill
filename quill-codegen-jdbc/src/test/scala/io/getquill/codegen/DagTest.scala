...
class CodeGeneratorRunnerDagTest extends AnyFunSuite with BeforeAndAfter {
  ...
  val cases = Seq(
    ...
    TestCase(
      classTag[Long],
      Seq(classTag[Boolean], classTag[Int], classTag[Byte], classTag[Long]),
      classTag[Long]
    ),
    TestCase(
      classTag[Int],
      Seq(classTag[Boolean], classTag[Int], classTag[Byte]),
      classTag[Int]
    ),
    TestCase(
      classTag[BigDecimal],
    ...
    TestCase(
      classTag[java.time.LocalDate],
      Seq(classTag[LocalDateTime]),
      classTag[LocalDateTime]
    ),
    TestCase(
      classTag[Short],
      Seq(classTag[Boolean], classTag[Byte]),
      classTag[Short]
    ),
    ...
    TestCase(
      classTag[UnknownClass],
      Seq(classTag[UnknownClass]),
      classTag[UnknownClass]
    ),
