...
object DatabaseTypes {
  ...
  case object H2 extends DatabaseType {
    def databaseName = "H2"; def context: Class[_ <: JdbcContext[_, _]] = classOf[H2JdbcContext[_]]; def dialect: Class[H2Dialect] = classOf[H2Dialect]
  }
  case object MySql extends DatabaseType {
    def databaseName = "MySQL"; def context: Class[_ <: JdbcContext[_, _]] = classOf[MysqlJdbcContext[_]]; def dialect: Class[MySQLDialect] = classOf[MySQLDialect]
  }
  case object SqlServer extends DatabaseType {
    def databaseName = "Microsoft SQL Server"; def context: Class[_ <: JdbcContext[_, _]] = classOf[SqlServerJdbcContext[_]];
  ...
  case object Sqlite extends DatabaseType {
    def databaseName = "SQLite"; def context: Class[_ <: JdbcContext[_, _]] = classOf[SqliteJdbcContext[_]]; def dialect: Class[SqliteDialect] = classOf[SqliteDialect]
  }
  case object Oracle extends DatabaseType {
    def databaseName = "Oracle"; def context: Class[_ <: JdbcContext[_, _]] = classOf[SqliteJdbcContext[_]]; def dialect: Class[OracleDialect] = classOf[OracleDialect]
  }
}
