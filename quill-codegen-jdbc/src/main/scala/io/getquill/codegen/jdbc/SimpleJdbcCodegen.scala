...
class SimpleJdbcCodegen(
  ...
  def this(connectionMaker: JdbcConnectionMaker, packagePrefix: String) =
    this(Seq(connectionMaker), packagePrefix)
  ...
  def this(config: Config, packagePrefix: String) =
    this(JdbcContextConfig(config), packagePrefix)
  def this(configPrefix: String, packagePrefix: String) =
    this(LoadConfig(configPrefix), packagePrefix)
