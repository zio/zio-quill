...
final case class BySomeTableData[Gen](val namer: Gen => java.nio.file.Path)(implicit val tt: scala.reflect.runtime.universe.TypeTag[Gen]) extends FileNamingStrategy
