...
object Stereotyper {
  ...
  type Expresser[TableMeta, ColumnMeta] =
    (RawSchema[TableMeta, ColumnMeta]) => TableStereotype[TableMeta, ColumnMeta]
  type Fuser[TableMeta, ColumnMeta] = (
      Seq[TableStereotype[TableMeta, ColumnMeta]]
...
trait Stereotyper extends HasBasicMeta {
  ...
  def stereotype(
      schemas: Seq[RawSchema[TableMeta, ColumnMeta]]
  ): Seq[TableStereotype[TableMeta, ColumnMeta]]
}
