...
trait Decoders {
  ...
  implicit val jodaLocalDateDecoder: Decoder[JodaLocalDate] = decoder[JodaLocalDate]({ case localDate: JodaLocalDate =>
                                                                                       localDate
                                                                                     },
                                                                                     SqlTypes.DATE
  )
