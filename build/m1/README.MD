...
`docker-compose -f docker-compose-m1.yml sbt sbt -Dmodules=db test`
...
`docker-compose -f docker-compose-m1.yml sbt sbt -Dquill.scala.version=2.13.6 -Dmodules=db test`
