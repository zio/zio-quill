...
sqlcmd -S sqlserver -U SA -P "$SQLSERVER_PASSWORD" -Q "CREATE DATABASE quill_test"
sqlcmd -S sqlserver -U SA -P "$SQLSERVER_PASSWORD" -d quill_test -i quill-sql/src/test/sql/sqlserver-schema.sql
