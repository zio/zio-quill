...
class SqlActionMacroSpec extends Spec {
  ...
  "runs actions" - {
    ...
    "insert returning generated" - {
      ...
      "multi" in testContext.withDialect(MirrorSqlDialectWithReturnMulti) {
        ctx =>
          import ctx._
          val q = quote {
            qr1
      ...
      "multi with record type returning" in testContext.withDialect(
        ...
        mirror.returningBehavior mustEqual ReturnColumns(
          List("s", "i", "l", "o", "b")
        )
      }
      "multi with record type returning generated should exclude all" in testContext
        .withDialect(MirrorSqlDialectWithReturnMulti) { ctx =>
          import ctx._
          val q = quote {
            qr1
              .insertValue(lift(TestEntity("s", 0, 1L, None, true)))
      ...
      "multi - should fail on operation" in testContext.withDialect(
        MirrorSqlDialectWithReturnMulti
      ) { ctx =>
        """import ctx._; quote { qr1.insert(lift(TestEntity("s", 0, 1L, None))).returningGenerated(r => (r.i, r.l + 1)) }""" mustNot compile
      }
      "multi - should fail on operation inside case class" in testContext
        .withDialect(MirrorSqlDialectWithReturnMulti) { ctx =>
      ...
      "no return - should fail on property" in testContext.withDialect(
        MirrorSqlDialectWithNoReturn
      ) { ctx =>
        """import ctx._; quote { qr1.insert(lift(TestEntity("s", 0, 1L, None))).returningGenerated(r => r.i) }""" mustNot compile
      }
      "returning clause - single" in testContext.withDialect(
      ...
      "returning clause - multi" in testContext.withDialect(
        MirrorSqlDialectWithReturnClause
      ) { ctx =>
        import ctx._
        val q = quote {
          qr1
            .insertValue(lift(TestEntity("s", 0, 1L, None, false)))
            .returningGenerated(r => (r.i, r.l, r.b))
        }
        val mirror = ctx.run(q)
        mirror.string mustEqual "INSERT INTO TestEntity (s,o) VALUES (?, ?) RETURNING i, l, b"
        mirror.returningBehavior mustEqual ReturnRecord
      }
      "returning clause - operation" in testContext.withDialect(
        MirrorSqlDialectWithReturnClause
      ) { ctx =>
        import ctx._
        val q = quote {
      ...
      "returning clause - record" in testContext.withDialect(
        MirrorSqlDialectWithReturnClause
      ) { ctx =>
        import ctx._
        val q = quote {
      ...
      "returning generated clause - record" in testContext.withDialect(
        MirrorSqlDialectWithReturnClause
      ) { ctx =>
        import ctx._
        val q = quote {
      ...
      "returning clause - embedded" - {
        ...
        "embedded property" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
            qr1Emb
              ...
              .returningGenerated(_.emb.i)
          }
          val mirror = ctx.run(q)
          mirror.string mustEqual "INSERT INTO TestEntity (s,l,o) VALUES (?, ?, ?) RETURNING i"
          mirror.returningBehavior mustEqual ReturnRecord
        }
        "two embedded properties" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
            qr1Emb
              .insertValue(lift(TestEntityEmb(Emb("s", 0), 1L, None)))
              .returningGenerated(r => (r.emb.i, r.emb.s))
          }
          val mirror = ctx.run(q)
          mirror.string mustEqual "INSERT INTO TestEntity (l,o) VALUES (?, ?) RETURNING i, s"
          mirror.returningBehavior mustEqual ReturnRecord
        }
        "query with filter using id - id should be excluded" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1Emb
                .insertValue(lift(TestEntityEmb(Emb("s", 0), 1L, None)))
                .returningGenerated(r =>
                  (query[Dummy].filter(d => d.i == r.emb.i).max)
                )
            }
            val mirror = ctx.run(q)
      ...
      "with returning clause - query" - {
        ...
        "simple not using id - id not excluded" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
        ...
        "shadow variable - id excluded - map" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
        ...
        "shadow variable - id excluded - filter" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
            qr1
              .insertValue(lift(TestEntity("s", 0, 1L, None, true)))
              .returningGenerated(r =>
                (query[Dummy].filter(d => d.i == r.i).max)
              )
          }
          val mirror = ctx.run(q)
        ...
        "shadow variable - id excluded - filter + max" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable, default values - id not excluded - map" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
                .insertValue(lift(TestEntity("s", 0, 1L, None, true)))
                .returningGenerated(r =>
                  (r.s, r.i, r.l, r.o, r.b, query[Dummy].map(r => r.i).max)
                )
            }
            val mirror = ctx.run(q)
        ...
        "shadow variable - id not excluded - filter + lifting" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val value = 123
            val q = quote {
              qr1
                .insertValue(lift(TestEntity("s", 0, 1L, None, true)))
                .returningGenerated(r =>
                  (query[Dummy].filter(r => r.i == lift(value)).max)
                )
            }
            val mirror = ctx.run(q)
        ...
        "shadow variable - id not excluded - map" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
        ...
        "shadow variable - id not excluded - join" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
        ...
        "shadow variable - id not excluded - flatMap" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
                ...
                .returningGenerated(r =>
                  (
                    query[Dummy]
                      .flatMap(r => query[Dummy].filter(s => r.i == s.i))
                      .map(_.i)
                      .max
                  )
                )
        ...
        "shadow variable - id not excluded - concatMap" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable - id not excluded - groupBy" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable - id not excluded - flatJoin" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable - id not excluded - sortBy" in testContext.withDialect(
          MirrorSqlDialectWithReturnClause
        ) { ctx =>
          import ctx._
          val q = quote {
        ...
        "shadow variable in multiple clauses - id not excluded" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
                ...
                .returningGenerated(r =>
                  (query[Dummy]
                    .filter(r =>
                      r.i == r.i /* always true since r overridden! */
                    )
                    .map(r => r.i)
                    .max)
                )
        ...
        "shadow variable in one of multiple clauses - id excluded" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
                .insertValue(lift(TestEntity("s", 0, 1L, None, true)))
                .returningGenerated(r =>
                  (query[Dummy].filter(d => d.i == r.i).map(r => r.i).max)
                )
            }
            val mirror = ctx.run(q)
        ...
        "shadow variable in one of multiple clauses - id excluded - two filter" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable in one of multiple clauses - id excluded - two filter plus tuple" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
      ...
      "output clause - single" in testContext.withDialect(
        MirrorSqlDialectWithOutputClause
      ) { ctx =>
        import ctx._
        val q = quote {
          qr1
      ...
      "output clause - multi" in testContext.withDialect(
        MirrorSqlDialectWithOutputClause
      ) { ctx =>
        import ctx._
        val q = quote {
      ...
      "output clause - operation" in testContext.withDialect(
        MirrorSqlDialectWithOutputClause
      ) { ctx =>
        import ctx._
        val q = quote {
      ...
      "output clause - record" in testContext.withDialect(
        MirrorSqlDialectWithOutputClause
      ) { ctx =>
        import ctx._
        val q = quote {
      ...
      "output clause - naming strategy renames INSERTED clause with correct column naming" in testContextSnake
        .withDialect(MirrorSqlDialectWithOutputClause) { ctx =>
          ...
          val q = quote {
            query[Person]
              .insertValue(lift(Person("Joe", 123)))
              .returning(p => p.firstName)
          }
      ...
      "output clause - should fail on query" in testContext.withDialect(
        MirrorSqlDialectWithOutputClause
      ) { ctx =>
    ...
    "insert returning" - {
      ...
      "with returning clause - query" - {
        ...
        "simple with id - id would be excluded (if was returningGenerated)" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "simple with filter using id - id would be excluded (if was returningGenerated)" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable - id not excluded (same as returningGenerated)" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
        ...
        "shadow variable in multiple clauses - id not excluded (same as returningGenerated)" in testContext
          .withDialect(MirrorSqlDialectWithReturnClause) { ctx =>
            import ctx._
            val q = quote {
              qr1
  ...
  "apply naming strategy to returning action" in testContext.withNaming(
    SnakeCase
  ) { ctx =>
    import ctx._
    ...
    val q = quote {
      query[TestEntity4]
        .insertValue(lift(TestEntity4(1, "s")))
        .returningGenerated(_.intId)
    }
    val mirror = ctx.run(q)
