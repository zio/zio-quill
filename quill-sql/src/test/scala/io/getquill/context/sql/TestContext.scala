...
class TestContextTemplate[Dialect <: SqlIdiom, Naming <: NamingStrategy](
    dialect: Dialect,
    naming: Naming
  ...
  def withNaming[N <: NamingStrategy](
      naming: N
  )(f: TestContextTemplate[Dialect, N] => Any): Unit = {
    val ctx = new TestContextTemplate[Dialect, N](dialect, naming)
    f(ctx)
    ctx.close
  }

  def withDialect[I <: SqlIdiom](
      dialect: I
  )(f: TestContextTemplate[I, Naming] => Any): Unit = {
...
object testContext
    extends TestContextTemplate[MirrorSqlDialect, Literal](
      MirrorSqlDialect,
      Literal
    )
object testContextSnake
    extends TestContextTemplate[MirrorSqlDialect, SnakeCase](
      MirrorSqlDialect,
      SnakeCase
    )
object testContextUpper
    extends TestContextTemplate[MirrorSqlDialect, getquill.UpperCaseNonDefault](
      MirrorSqlDialect,
      UpperCaseNonDefault
    )
object testContextEscape
    extends TestContextTemplate[MirrorSqlDialect, Escape](
      MirrorSqlDialect,
      Escape
    )
object testContextEscapeAndAlias
    extends TestContextTemplate[MirrorSqlDialect, Escape](
      MirrorSqlDialect,
      Escape
    )
object testContextUpperEscapeColumn
    extends TestContextTemplate[
      MirrorSqlDialect,
      getquill.UpperCaseEscapeColumn
    ](MirrorSqlDialect, UpperCaseEscapeColumn)
object testContextEscapeElements
    extends TestContextTemplate[MirrorSqlDialect.StrategizeElements, Escape](
      MirrorSqlDialect.StrategizeElements,
      Escape
    )
