...
trait CassandraContext[N <: NamingStrategy, R, S]
  ...
  ): ActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, T, O](
    quoted: Quoted[P1 => Action[T, O]]
  ): Params[P1] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, T, O](
    quoted: Quoted[(P1, P2) => Action[T, O]]
  ): Params[(P1, P2)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, T, O](
    quoted: Quoted[(P1, P2, P3) => Action[T, O]]
  ): Params[(P1, P2, P3)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, T, O](
    quoted: Quoted[(P1, P2, P3, P4) => Action[T, O]]
  ): Params[(P1, P2, P3, P4)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, P5, T, O](
    quoted: Quoted[(P1, P2, P3, P4, P5) => Action[T, O]]
  ): Params[(P1, P2, P3, P4, P5)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, P5, P6, T, O](
    quoted: Quoted[(P1, P2, P3, P4, P5, P6) => Action[T, O]]
  ): Params[(P1, P2, P3, P4, P5, P6)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, P5, P6, P7, T, O](
    quoted: Quoted[(P1, P2, P3, P4, P5, P6, P7) => Action[T, O]]
  ): Params[(P1, P2, P3, P4, P5, P6, P7)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, P5, P6, P7, P8, T, O](
    quoted: Quoted[(P1, P2, P3, P4, P5, P6, P7, P8) => Action[T, O]]
  ): Params[(P1, P2, P3, P4, P5, P6, P7, P8)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, P5, P6, P7, P8, P9, T, O](
    quoted: Quoted[(P1, P2, P3, P4, P5, P6, P7, P8, P9) => Action[T, O]]
  ): Params[(P1, P2, P3, P4, P5, P6, P7, P8, P9)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
  def run[P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, T, O](
    quoted: Quoted[(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) => Action[T, O]]
  ): Params[(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)] => BatchedActionResult[T, O] = macro CassandraContextMacro.run[R, S]
