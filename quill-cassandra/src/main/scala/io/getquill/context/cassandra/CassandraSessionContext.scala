...
abstract class CassandraSessionContext[N <: NamingStrategy] extends CassandraBaseContext[N] with CassandraContext[N] {
  ...
  protected def prepareAsyncAndGetStatement(cql: String, prepare: Prepare, logger: ContextLogger)(implicit
